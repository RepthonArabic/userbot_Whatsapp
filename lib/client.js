...
try {
    ...
    console.log("🌍 جار الاتصال بقاعدة البيانات DB")
} catch {
    console.log("خطأ في الحصول على قاعدة البيانات")
    process.exit(0)
}
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === "connecting") {
                   console.log("ℹ️ جار الاتصال بحسابك على الواتساب انتظر");
                }
                if (connection === 'open') {
                    console.log("✅ تم الاتصال!");
                    console.log("⬇️  جار تنزيل الاوامر");
                    ...
                    console.log("✅  تم تحميل الأوامر بنجــاح!");
